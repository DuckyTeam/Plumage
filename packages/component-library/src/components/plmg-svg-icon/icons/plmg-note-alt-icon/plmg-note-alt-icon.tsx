...
@Component({
  tag: 'plmg-note-alt-icon',
  styleUrl: '../../plmg-svg-icon.scss',
  shadow: false,
})
export class NoteAltIcon {
  /**
    ...
    return (
      <Host class={{ 'plmg-svg-icon': true }}>
        ...
        >
          ...
          <path d="m15.08 11.03-2.12-2.12L7 14.86V17h2.1zm1.77-1.76c.2-.2.2-.51 0-.71l-1.41-1.41c-.2-.2-.51-.2-.71 0l-1.06 1.06 2.12 2.12 1.06-1.06z" />
        </svg>
      </Host>
    );
  }
