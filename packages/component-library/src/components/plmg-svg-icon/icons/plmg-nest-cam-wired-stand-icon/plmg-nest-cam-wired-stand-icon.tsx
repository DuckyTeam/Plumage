...
@Component({
  tag: 'plmg-nest-cam-wired-stand-icon',
  styleUrl: '../../plmg-svg-icon.scss',
  shadow: false,
})
export class NestCamWiredStandIcon {
  /**
