...
@Component({
  tag: 'plmg-media-bluetooth-off-icon',
  styleUrl: '../../plmg-svg-icon.scss',
  shadow: false,
})
export class MediaBluetoothOffIcon {
  /**
