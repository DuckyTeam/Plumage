...
@Component({
  tag: 'plmg-share-location-icon',
  styleUrl: '../../plmg-svg-icon.scss',
  shadow: false,
})
export class ShareLocationIcon {
  /**
    ...
    return (
      <Host class={{ 'plmg-svg-icon': true }}>
        ...
        >
          ...
          <path d="M16 11.1C16 8.61 14.1 7 12 7s-4 1.61-4 4.1c0 1.66 1.33 3.63 4 5.9 2.67-2.27 4-4.24 4-5.9zm-4 .9c-.59 0-1.07-.48-1.07-1.07 0-.59.48-1.07 1.07-1.07s1.07.48 1.07 1.07c0 .59-.48 1.07-1.07 1.07z" />
        </svg>
      </Host>
    );
  }
