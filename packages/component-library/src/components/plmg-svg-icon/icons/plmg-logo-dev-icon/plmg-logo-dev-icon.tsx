...
@Component({
  tag: 'plmg-logo-dev-icon',
  styleUrl: '../../plmg-svg-icon.scss',
  shadow: false,
})
export class LogoDevIcon {
  /**
    ...
    return (
      <Host class={{ 'plmg-svg-icon': true }}>
        ...
        >
          ...
          <path d="M7.77 10.12h-.63v3.77h.63c.14 0 .28-.05.42-.16.14-.1.21-.26.21-.47v-2.52c0-.21-.07-.37-.21-.47-.14-.1-.28-.15-.42-.15z" />
        </svg>
      </Host>
    );
  }
