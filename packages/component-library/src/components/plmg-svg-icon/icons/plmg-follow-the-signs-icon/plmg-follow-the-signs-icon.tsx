...
@Component({
  tag: 'plmg-follow-the-signs-icon',
  styleUrl: '../../plmg-svg-icon.scss',
  shadow: false,
})
export class FollowTheSignsIcon {
  /**
