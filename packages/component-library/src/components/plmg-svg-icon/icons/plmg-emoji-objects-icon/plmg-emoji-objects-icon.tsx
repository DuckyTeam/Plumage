...
@Component({
  tag: 'plmg-emoji-objects-icon',
  styleUrl: '../../plmg-svg-icon.scss',
  shadow: false,
})
export class EmojiObjectsIcon {
  /**
    ...
    return (
      <Host class={{ 'plmg-svg-icon': true }}>
        ...
        >
          ...
          <path d="m9.6724 9.5808.7071-.7071 2.1214 2.1213-.7071.7071z" />
          <path d="m12.2081 11.7124-.707-.7071 2.1212-2.1214.7071.7072z" />
        </svg>
      </Host>
    );
  }
