...
@Component({
  tag: 'plmg-mic-external-off-icon',
  styleUrl: '../../plmg-svg-icon.scss',
  shadow: false,
})
export class MicExternalOffIcon {
  /**
