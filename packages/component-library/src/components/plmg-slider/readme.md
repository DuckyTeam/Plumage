...
| `name`         | `name`          | Define a descriptive name for the slider  Allowed values: - any string  Used internally by the component to connect inputs and outputs  Required for accessibility and should be a unique and descriptive                                                                                                                    | `string`   | `undefined` |
