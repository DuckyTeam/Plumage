...
| `textInputWidth`     | `text-input-width` | Define text input field width  Allowed values: - Any positive number  Override the default width of the text input field with a pixel value  By default the text input field width is set by the max value of the range                                                                                                               | `number`  | `undefined` |
