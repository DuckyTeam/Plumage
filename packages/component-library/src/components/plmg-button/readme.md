...
| `disabled`   | `disabled`    | Define button's disabled state Default: false Allowed values: - true - false                                                                                                                                                                                                                                                                                                                                                                                                | `boolean`                                                                    | `false`     |
...
| `iconColor`  | `icon-color`  | Define icon's color.  Can be any valid CSS color value.  By default, the icon will have the same color as the parent's element.                                                                                                                                                                                                                                                                                                                                             | `string`                                                                     | `undefined` |
...
| `text`       | `text`        | The text to display in the button                                                                                                                                                                                                                                                                                                                                                                                                                                           | `string`                                                                     | `undefined` |
