...
describe('plmg-button', () => {
  ...
  it('renders a disabled anchor element when href is provided and disabled is true', async () => {
    ...
    <plmg-button href="https://www.ducky.eco" text="Content" style="width: fit-content;" disabled>
        <a class="disabled filled medium plmg-button primary" aria-disabled href="https://www.ducky.eco" style="pointer-events: none;">
        Content
        </a>
    </plmg-button>
    `);
  ...
  it('renders a disabled button', async () => {
    ...
    expect(page.root).toEqualHtml(`
      <plmg-button disabled="true" full-width="true" style="width: full-width;" text="disabled">
           <button aria-disabled disabled class="disabled filled full-width medium plmg-button primary" type="button" style="pointer-events: none;" >
             disabled
           </button>
        </plmg-button>
      `);
