...
| `forceVisible`    | `force-visible`     | Force tooltip to remain visible for demostration pu  Disables event listener                                   | `boolean`                                          | `false`     |
| `targetElementId` | `target-element-id` | ID for connected element. Required.                                                                            | `string`                                           | `undefined` |
| `tooltipTitle`    | `tooltip-title`     | Tooltip Title Text  Any string  Required                                                                       | `string`                                           | `undefined` |
