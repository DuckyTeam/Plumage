...
| `max`                | `max`           | Define the max value when type is number  Allowed values: - Any number  Only vaiid for type: number  Default: none                                                                                                                                           | `number`                                                                    | `undefined` |
| `maxLength`          | `max-length`    | Define the maximum character length  Allowed values: - Any number  Not valid for type: number  Default: none                                                                                                                                                 | `number`                                                                    | `undefined` |
| `min`                | `min`           | Define the min value when type is number  Allowed values: - Any number  Only vaiid for type: number                                                                                                                                                          | `number`                                                                    | `undefined` |
| `minLength`          | `min-length`    | Define the mininum character length  Allowed values: - Any number  Not valid for type: number  Default: none                                                                                                                                                 | `number`                                                                    | `undefined` |
| `name`               | `name`          | Define a name for the input field.  Allowed values: - Any string  A unique name for each element should be provided.                                                                                                                                         | `string`                                                                    | `undefined` |
| `pattern`            | `pattern`       | Define a regular expression pattern for constraint validation  Allowed value: any string  Only valid for type: text, email, password, search, tel, url  Default: none                                                                                        | `string`                                                                    | `undefined` |
| `placeholder`        | `placeholder`   | Define a placeholder  Allowed value: any string  Placeholder does not set a value.  Default: none                                                                                                                                                            | `string`                                                                    | `undefined` |
...
| `width`              | `width`         | Define width  Allowed values: - Any positive number greater than 0  Define how many characters wide the input field should be.  When type is number, width sets the pixel width of the input field.  By default width is set to 100% of the parent container | `number`                                                                    | `undefined` |
...
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| `valueUpdated` | Event emitted when value changed. Event emitted is an object with the following properties: - name: name of the input - value: value of the input - validityState object containing constraint validity states | `CustomEvent<{ name: string; value: string; validity: ValidityState; }>` |
