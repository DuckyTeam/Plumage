...
| `width`              | `width`         | Define width  Allowed values: - Any positive number greater than 0  Define the width of the text input  When type is number, width sets the pixel width of the input field.  By default width is set to 100% of the parent container | `number`                                                                    | `undefined` |
